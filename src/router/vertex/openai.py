"""
OpenAI Router - Handles OpenAI format API requests via Vertex AI
通过Vertex AI处理OpenAI格式请求的路由模块
"""
...
async def chat_completions(
    ...
    Args:
        ...
        token: Bearer认证令牌
    """
    log.debug(f"[VERTEX-OPENAI-OPENAI] Request for model: {openai_request.model}")
