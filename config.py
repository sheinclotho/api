...
async def get_vertex_ai_location() -> str:
    """
    Get Vertex AI location setting.

    Vertex AI 区域配置，用于构建 Vertex AI API 端点 URL。

    Environment variable: VERTEX_AI_LOCATION
    Database config key: vertex_ai_location
    Default: us-central1
    """
